...
// Measurement generates a random temperature measurement for the WeatherStation.
func (ws *WeatherStation) Measurement() float64 {
	// Gaussian (normal) distribution with a standard deviation of 10
	measurement := rand.NormFloat64()*10 + ws.MeanTemperature
	// Round to 1 decimal place
	return float64(int(measurement*10+0.5)) / 10.0
}
...
func main() {
	...
	for i := 0; i < size; i++ {
		...
		bw.WriteString(fmt.Sprintf("%s;%.1f\n", station.ID, measurement))
	}
	bw.Flush()
